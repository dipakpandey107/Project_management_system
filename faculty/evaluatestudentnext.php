    ...
    <body>
        ...
        <div class="container";>
            ...
            include 'php/connection.php';
                $result = mysqli_query($conn, "SELECT * from projectgroup where group_id='$group_id'");
                $result=mysqli_fetch_array($result);
                ?>
                    <h3 class="panel-title"> <h3 class="panel-title"></h3>Project Name : <?php echo $result["project_title"]; ?></h3>
                    <div class="right">  
                    </div>
                </div>
            ...
            <div class="container" id="datatable">
                <div class="row">
                    <div class="col-12">
                        ...
                        <form action="entermarks.php" method="post" id="members">
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    <th scope="col">Select Members </th>
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    <tr>
                                        ...
                                        <td ><input id="in" type="checkbox" name="students[]"  value="<?php echo $row["e"]; ?>" ><?php echo "    ".$row["name"]; ?></td>
                            ...
                            <input type="hidden" name="evalution" value="<?php echo $_POST["evalution"]; ?>">
                            <input type="hidden" name="project" value="<?php echo $_POST["project"]; ?>">
                            <input type="submit" value="Next" style="color:green" name="selectmember" id="s">
