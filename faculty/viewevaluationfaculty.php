                        ...
                        <tbody>
                            <?php
                                ...
                                if (isset($_POST["searchbtn"])) {
                                    $s = $_POST["search"];
                                    $query = "select * from sheduleevalution,course where course.course_id=sheduleevalution.course_id and concat(coursename,eval_name,edate) like '%$s%'";
                                } else {
                                    $query = "select * from sheduleevalution,course where course.course_id=sheduleevalution.course_id";
                                }
